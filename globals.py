...
FEATURE_ID_DELIM = "-"
ELIGIBLE_FEATURE_TYPES = frozenset(["project", "demo", "cancer", "expr", "rawexpr", "text", "text_sum_bm", "text_sum_m", "text_sum_co", "hist_mean", "hist_max"])
...
INCOMPATIBLE_FEATURE_TYPES = [
    ...
    frozenset(["text", "text_sum_bm", "text_sum_m", "text_sum_co"]),
]
